...
static char __pyx_k_gif_tree__utils[] = "gif.tree._utils";
...
static char __pyx_k_Users_jmbegon_github_globally_i[] = "/Users/jmbegon/github/globally-induced-forest/gif/tree/_utils.pyx";
 ...
 *         free(p)
 */
  __pyx_fuse_1__pyx_f_3gif_4tree_6_utils_safe_realloc((&__pyx_v_p), (((size_t)-1L) / 2)); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 46; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static PyObject *__pyx_tp_new_3gif_4tree_6_utils_Stack(PyTypeObject *t, PyObject *a, PyObject *k) {
  ...
  if (unlikely(__pyx_pw_3gif_4tree_6_utils_5Stack_1__cinit__(o, a, k) < 0)) {
    Py_DECREF(o); o = 0;
  }
  return o;
}
...
static PyObject *__pyx_tp_new_3gif_4tree_6_utils_PriorityHeap(PyTypeObject *t, PyObject *a, PyObject *k) {
  ...
  if (unlikely(__pyx_pw_3gif_4tree_6_utils_12PriorityHeap_1__cinit__(o, a, k) < 0)) {
    Py_DECREF(o); o = 0;
  }
  return o;
}
 ...
 */
  ...
  __pyx_codeobj__8 = (PyObject*)__Pyx_PyCode_New(0, 0, 1, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__7, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_Users_jmbegon_github_globally_i, __pyx_n_s_realloc_test, 42, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 42; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#endif
{
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "gif.tree._utils")) {
      if (unlikely(PyDict_SetItemString(modules, "gif.tree._utils", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  if (__Pyx_ExportFunction("sizet_ptr_to_ndarray", (void (*)(void))__pyx_f_3gif_4tree_6_utils_sizet_ptr_to_ndarray, "PyArrayObject *(__pyx_t_3gif_4tree_6_utils_SIZE_t *, __pyx_t_3gif_4tree_6_utils_SIZE_t)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("rand_int", (void (*)(void))__pyx_f_3gif_4tree_6_utils_rand_int, "__pyx_t_3gif_4tree_6_utils_SIZE_t (__pyx_t_3gif_4tree_6_utils_SIZE_t, __pyx_t_3gif_4tree_6_utils_SIZE_t, __pyx_t_3gif_4tree_6_utils_UINT32_t *)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("rand_uniform", (void (*)(void))__pyx_f_3gif_4tree_6_utils_rand_uniform, "double (double, double, __pyx_t_3gif_4tree_6_utils_UINT32_t *)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("log", (void (*)(void))__pyx_f_3gif_4tree_6_utils_log, "double (double)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("__pyx_fuse_0safe_realloc", (void (*)(void))__pyx_fuse_0__pyx_f_3gif_4tree_6_utils_safe_realloc, "__pyx_t_3gif_4tree_6_utils_DTYPE_t *(__pyx_t_3gif_4tree_6_utils_DTYPE_t **, size_t)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("__pyx_fuse_1safe_realloc", (void (*)(void))__pyx_fuse_1__pyx_f_3gif_4tree_6_utils_safe_realloc, "__pyx_t_3gif_4tree_6_utils_SIZE_t *(__pyx_t_3gif_4tree_6_utils_SIZE_t **, size_t)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("__pyx_fuse_2safe_realloc", (void (*)(void))__pyx_fuse_2__pyx_f_3gif_4tree_6_utils_safe_realloc, "unsigned char *(unsigned char **, size_t)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  /*--- Type init code ---*/
  ...
  if (PyType_Ready(&__pyx_type_3gif_4tree_6_utils_Stack) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 90; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_type_3gif_4tree_6_utils_Stack.tp_print = 0;
  if (__Pyx_SetVtable(__pyx_type_3gif_4tree_6_utils_Stack.tp_dict, __pyx_vtabptr_3gif_4tree_6_utils_Stack) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 90; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (PyObject_SetAttrString(__pyx_m, "Stack", (PyObject *)&__pyx_type_3gif_4tree_6_utils_Stack) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 90; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  if (PyType_Ready(&__pyx_type_3gif_4tree_6_utils_PriorityHeap) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 208; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_type_3gif_4tree_6_utils_PriorityHeap.tp_print = 0;
  if (__Pyx_SetVtable(__pyx_type_3gif_4tree_6_utils_PriorityHeap.tp_dict, __pyx_vtabptr_3gif_4tree_6_utils_PriorityHeap) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 208; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (PyObject_SetAttrString(__pyx_m, "PriorityHeap", (PyObject *)&__pyx_type_3gif_4tree_6_utils_PriorityHeap) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 208; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     # bytes, which will always overflow.
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_3gif_4tree_6_utils_1_realloc_test, NULL, __pyx_n_s_gif_tree__utils); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 42; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
